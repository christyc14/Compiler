...
input_dir="compiler_tests_organized_adv"
input_dir_prog="compiler_tests_organized_adv/programs"
...
for i in ${input_dir_prog}/"array"*.c ; do #for a specific type test, do /"integer_"*.c
#types are: array, control_flow, functions, integer, misc, test
